...
from qfluentwidgets import CardWidget, PrimaryPushButton, ComboBox, Slider, FluentIcon, setTheme, Theme
...
class VoicePage(QWidget):
    ...
    def _createTestCard(self):
        ...
        layout.addWidget(title_label)
        layout.addWidget(self.showWindowButton)
    ...
    def _showStatus(self, message):
        ...
        QTimer.singleShot(3000, lambda: self.statusLabel.setVisible(False))
