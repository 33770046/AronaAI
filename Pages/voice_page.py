...
from qfluentwidgets import CardWidget, PrimaryPushButton, ComboBox, Slider, FluentIcon, ScrollArea, setTheme, Theme, LineEdit
...
class VoicePage(QWidget):
    ...
    def _setupUi(self):
        ...
        title = QLabel("声音与窗口", self._scrollContent)
    ...
    def _createVolumeCard(self):
        ...
        title_label = QLabel("音量", self._scrollContent)
        title_label.setObjectName("title-label")
        
        slider_layout = QHBoxLayout()
        slider_layout.setSpacing(12)
        
        self.volumeSlider = Slider(Qt.Horizontal, self._scrollContent)
        ...
        self.volumeText = QLabel("100%", self._scrollContent)
    ...
    def _createLanguageCard(self):
        ...
        self.languageComboBox = ComboBox(self._scrollContent)
    ...
    def _createThemeCard(self):
        ...
        self.themeComboBox = ComboBox(self._scrollContent)
    ...
    def _createTestCard(self):
        ...
        title_label = QLabel("测试", self._scrollContent)
        title_label.setObjectName("title-label")
        
        self.showWindowButton = PrimaryPushButton("显示窗口", self._scrollContent)
        ...
        self.statusLabel = QLabel("", self._scrollContent)
        ...
        self.hotkeyInput = LineEdit(self._scrollContent)
    ...
    def _applyStyles(self):
        ...
        self._scrollContent.setStyleSheet("QWidget { background: transparent; }")
        ...
        if status_label:
            status_label.setStyleSheet(f"font-size: 14px; color: #4caf50; padding: 8px; background: {status_bg}; border-radius: 4px;")
